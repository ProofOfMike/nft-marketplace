...
export const dashboardTabs = [
  ...
  },
  {
    id: 6,
    tabname: 'Settings',
    icon: <IconSettings className="ti ti-settings fs-five n5-color" />,
  },
  {
    id: 7,
    tabname: 'Notifications',
    icon: <IconBellRinging className="ti ti-bell-ringing fs-five n5-color" />,
  },
  {
    id: 8,
    tabname: 'Log out',
    icon: <IconLogout className="ti ti-logout fs-five n5-color" />,
  },
];
