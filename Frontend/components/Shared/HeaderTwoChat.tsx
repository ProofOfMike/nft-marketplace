  ...
  return (
    <>
      <div className="cmn-head">
        ...
        <div
          className={`cmns_msgarea msg_area common_area2 p2-bg rounded-2 ${isCardExpanded ? '' : 'massagearashow'}`}
        >
            ...
            <div className="d-flex align-items-center gap-2">
              <button type="button">
                <IconMenu2
                  height={24}
                  width={24}
                  className="ti ti-menu-2 fs-four n5-color"
                />
              </button>
          ...
          <div className="cmns_msgarea__body p-5 p-md-6">
            <div className="d-flex align-items-start gap-4 mb-4">
              ...
              <div className="cmns_msgarea__head-conent">
                ...
                <p>
                  Etiam consequat tellus sem, eget ullamcorper arcu convallis
                  eu.
                </p>
              </div>
            </div>
            ...
            <div className="d-flex align-items-start gap-4 mb-4">
              ...
              <div className="cmns_msgarea__head-conent">
                ...
                <Image
                  src="/images/etiam-consequat.png"
                  height={500}
                  width={287}
                  alt="Icon"
                />
              ...
              <div className="cmns_msgarea__footer-fileup d-flex align-items-center py-1 pe-3 gap-sm-1">
                ...
                <label>
                  <IconPhotoPlus
                    width={24}
                    height={24}
                    className="ti ti-photo-plus fs-four cpoint"
                  />
                </label>
                ...
                <span>
                  <IconAt
                    width={24}
                    height={24}
                    className="ti ti-at fs-four cpoint"
                  />
                </span>
                <label>
                  <IconFileTypePdf
                    width={24}
                    height={24}
                    className="ti ti-file-type-pdf fs-four cpoint"
                  />
                </label>
                ...
                <span>
                  <IconMoodHappy
                    width={24}
                    height={24}
                    className="ti ti-mood-happy fs-four cpoint"
                  />
                </span>
                <button className="py-3 px-5 g1-bg rounded-8">
                  <IconSend
                    width={24}
                    height={24}
                    className="ti ti-send fs-four"
                  />
                </button>
              </div>
            </form>
