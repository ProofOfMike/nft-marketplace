                      ...
                      <Tab.Panels className="tabcontents">
                        ...
                        <Tab.Panel>
                          ...
                          <div className="pay_method__paymethod p-4 p-lg-6 p2-bg rounded-8">
                            ...
                            <div className="pay_method__amount d-flex align-content-center justify-content-between py-3 px-5 px-md-6 mb-6 mb-md-8 flex-wrap gap-3">
                              <div className="pay_method__amount-actual">
                                <span className="fs-seven mb-3">
                                  Actual balance
                                </span>
                            ...
                            >
                              <table className="w-100 text-center p2-bg">
                                ...
                                <tr>
                                  ...
                                  <td>Bank / CC</td>
                                  <td>5,591 USD</td>
                                  <td className="r1-color fw-normal cpoint">
                                    Cancel
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>Credit Card</td>
                                  <td>5,591 USD</td>
                                  <td className="g1-color fw-normal cpoint">
                                    Complete
                                  </td>
                                </tr>
                                <tr>
                            ...
                            >
                              <table className="w-100 text-center p2-bg">
                                ...
                                <tr>
                                  ...
                                  <td className="g1-color fw-normal cpoint text-nowrap">
                                    Complete
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <div className="d-flex align-items-center flex-wrap flex-md-nowrap gap-5 gap-md-6 mb-5">
                                  ...
                                  <div className="w-100">
                                    ...
                                    <select className="n11-bg extrastyle rounded-8 w-100 py-3 pe-5">
                                      <option
                                        className="p6-color"
                                        data-display="Male & Female..."
                                      >
                                        Male & Female...
                                      </option>
                                      <option className="p6-color" value="1">
                                        Male
                                      </option>
                                      <option className="p6-color" value="2">
                                        Female
                                      </option>
                                    </select>
                                  </div>
