                ...
                <div className="row w-100 gy-6">
                  ...
                  {promotionData.map(({ id, imgSrc, title, bonusvalue }) => (
                    <div className="col-xxl-6" key={id}>
                      <div className="Promotions__card d-flex align-items-center justify-content-center justify-content-sm-between flex-wrap flex-sm-nowrap gap-6 p-4 p-lg-10 rounded-8 p3-bg">
                        ...
                        <div className="Promotions__card-content text-center text-sm-start">
                          ...
                          <span className="fs-two mb-10 mb-md-15 d-block">
                            {bonusvalue}
                          </span>
                          <button type="button" className="cmn-btn px-5 py-3">
                            Get Bonus
                          </button>
                        </div>
                      </div>
